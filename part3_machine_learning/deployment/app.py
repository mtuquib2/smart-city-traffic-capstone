"""
deployment/app.py - FastAPI service serving the champion models and the recommendation engine.
...
Run (from part3_machine_learning/):
    python -m deployment.serve                     # uvicorn on http://127.0.0.1:8000, docs at /docs
"""
...
from recommendation_system.recommender import TravelRecommender, TripRequest  # noqa: E402

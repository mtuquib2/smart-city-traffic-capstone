...
# Orchestration
# ---------------------------------------------------------------------------
def run_pipeline(input_path: Path, clean_output: Path) -> pd.DataFrame:
    """Run load -> validate -> clean and persist the cleaned dataset."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        run_pipeline(args.input, args.clean_output)

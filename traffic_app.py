...
Examples
--------
    python traffic_app.py lookup --datetime "2017-12-25 17:00"
    python traffic_app.py peaks --top 3 --day-type weekend
    python traffic_app.py recommend --day monday --start 7 --end 19
